...
uint256 hashGenesisBlock("0xdd5429fc3b2854b997dc269fd3b1d12523f8c8a6ce62bea25e293b6d9b83a143");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(504365644); // ElliteCoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "ElliteCoin Signed Message:\n";
...
{
    // ElliteCoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 840000); // ElliteCoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 302400; // ElliteCoin: 3.5 days
static const int64 nTargetSpacing = 150; // ElliteCoin: 2.5 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // ElliteCoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // ElliteCoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // ElliteCoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xdd5429fc3b2854b997dc269fd3b1d12523f8c8a6ce62bea25e293b6d9b83a143");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("6660daea6484fcf6823a5ee6bb0031ace17980e3f050fdde9dd234584d3ab6546cc9c64a0ed982f819080e4b8c2357fd0b0c4894b5109ca01b37b4b5767fa258e3") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1494734130;
        block.nBits    = 504365644;
        block.nNonce   = 1463444752;
...
uint256 hash = block.GetHash();
        ...
        assert(block.hashMerkleRoot == uint256("0x3565facc583beec12f6627abb0ad41187fcea08634b50b62adb9411300ab2fbc")); //I dont now it's true or false, I left it like that
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // ElliteCoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("ElliteCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("ElliteCoinMiner : ProcessBlock, block not accepted");
    }
